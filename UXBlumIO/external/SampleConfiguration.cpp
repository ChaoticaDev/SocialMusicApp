...
Array<Scenario>^ MainPage::scenariosInner = ref new Array<Scenario>
{
	...
	{ "Background task", "UXBlumIO.SampleBackgroundTask" },
	{ "Background task with a condition", "UXBlumIO.SampleBackgroundTaskWithCondition" },
	{ "Servicing complete task", "UXBlumIO.ServicingCompleteTask" },
	{ "Background task with time trigger", "UXBlumIO.TimeTriggeredTask" },
	{ "Background task with application trigger", "UXBlumIO.ApplicationTriggerTask" }
};
